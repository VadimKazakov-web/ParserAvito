...
* Реализована функция обновления программы. После нажатия на кнопку "проверить обновления",
  ...
  появляется кнопка "загрузить", после нажатие на которую происходит загрузка новой программы из хранилища S3,
  её запуск и закрытие программы старой версии.
* На иконку программы автоматически наносится номер её версии с помощью библиотеки **Pillow**.
  <figure>
      <img src="https://s3.twcstorage.ru/parser-avito-download/githab_image/different_ones_icon.png" width="300" alt="иконка">
