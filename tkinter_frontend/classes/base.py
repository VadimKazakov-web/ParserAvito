...
class Base(ConfigClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not Base.style_frame_update:
            # шаблон для имени стиля должен быть именно такой: <name>.TFrame, <name>.TButton, <name>.TLabel и т.д...
            Base.style_frame_update = ttk.Style().configure(style='Update.TFrame', background="red")
