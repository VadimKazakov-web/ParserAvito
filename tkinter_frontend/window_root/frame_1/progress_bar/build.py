...
label_title_page = Label(master=frame, text=data_for_prog.get("page_title"), column=0, row=7)
label_title_page_origin = label_title_page.get_instance()
label_title_page.build()
label = Label(master=frame, text=data_for_prog.get("text"), column=0, row=8)
