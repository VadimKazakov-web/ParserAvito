...
active_inactive_start_button = ActiveInactiveButton(button_custom, button_instance,
                                                    lambda _: ROOT.event_generate(Events.push_start_event))
...
button_instance.bind(Events.post_var_event_btn, func=active_inactive_start_button.make_inactive_button)
